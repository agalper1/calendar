...
export default {
  ...
  methods: {
    onSubmit(event) {
      ...
      this.axios.post('http://galperin.studio-m.mi.hs-offenburg.de/api/meeting', {
        ...
        this.axios.put('http://galperin.studio-m.mi.hs-offenburg.de/api/meeting' + this.meetingId, {
          id: this.meetingId,
          title: this.form.title,
          weekly: this.form.weekly ? this.weekNr : 'unique meeting',
          link: this.form.link,
